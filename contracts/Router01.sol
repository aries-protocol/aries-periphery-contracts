...
contract Router01 is IRouter01, IAriesCallee {
    ...
    function getBorrowable(address uniswapV2Pair, uint8 index) public view virtual override returns (address borrowable) {
    ...
    function getCollateral(address uniswapV2Pair) public view virtual override returns (address collateral) {
        collateral = address(
            uint256(
                keccak256(
                    abi.encodePacked(
