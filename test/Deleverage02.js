...
contract("Deleverage02", function (accounts) {
    ...
    it("deleverage", async () => {
        ...
        await expectRevert(
            deleverage(router, uniswapV2Pair, borrower, LP_DLVRG_TOKENS, ETH_DLVRG_MIN, UNI_DLVRG_MIN, "0x", ETH_IS_A),
        ...
        await expectRevert(
            deleverage(router, uniswapV2Pair, borrower, "0", ETH_DLVRG_MIN, UNI_DLVRG_MIN, permit, ETH_IS_A),
            "AriesRouter: REDEEM_ZERO"
        );
        await expectRevert(
            deleverage(router, uniswapV2Pair, borrower, LP_DLVRG_TOKENS, ETH_DLVRG_HIGH, UNI_DLVRG_MIN, permit, ETH_IS_A),
            ETH_IS_A ? "AriesRouter: INSUFFICIENT_A_AMOUNT" : "AriesRouter: INSUFFICIENT_B_AMOUNT"
        );
        await expectRevert(
            deleverage(router, uniswapV2Pair, borrower, LP_DLVRG_TOKENS, ETH_DLVRG_MIN, UNI_DLVRG_HIGH, permit, ETH_IS_A),
        ...
        const receipt = await deleverage(router, uniswapV2Pair, borrower, LP_DLVRG_TOKENS, ETH_DLVRG_MIN, UNI_DLVRG_MIN, permit, ETH_IS_A);
    ...
    it("deleverage with refund UNI", async () => {
        ...
        const receipt = await deleverage(router, uniswapV2Pair, borrower, LP_DLVRG_TOKENS, "0", "0", permit, ETH_IS_A);
